...
validation_datagen = ImageDataGenerator(rescale=1/255.0, dtype=np.float32)
test_datagen = ImageDataGenerator(rescale = 1/255.0, dtype=np.float32)
...
# Define Evaluation Metrics and Compile the Model
METRICS = [
